// libs/messenger/chat-state/src/lib/services/chat-sync-orchestrator.service.spec.ts

import { TestBed } from '@angular/core/testing';
import { ChatSyncOrchestratorService } from './chat-sync-orchestrator.service';
...
describe('ChatSyncOrchestratorService', () => {
  let service: ChatSyncOrchestratorService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ChatSyncOrchestratorService);
  });
