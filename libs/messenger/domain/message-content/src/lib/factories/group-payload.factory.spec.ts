...
import { GroupPayloadFactory } from './group-payload.factory';
...
describe('MessagePayloadFactory', () => {
  ...
  it('should create valid Group Invite structure', () => {
    const result = GroupPayloadFactory.createGroupInvite(
      groupUrn,
      inviterUrn,
      'My Group',
  ...
  it('should create valid Joined Signal', () => {
    const result = GroupPayloadFactory.createJoinedSignal(groupUrn);
