import { OutboundTask, OutboundMessageRequest, DeliveryStatus, RecipientProgress } from '@nx-platform-application/messenger-types';
/**
 * CONTRACT: Outbox Storage
 * Defined in Infrastructure (Layer 1).
 * Consumed by Domain (Layer 2) to decouple logic from Dexie.
 */
export declare abstract class OutboxStorage {
    /**
    ...
    abstract updateTaskStatus(taskId: string, status: DeliveryStatus): Promise<void>;
    abstract updateRecipientProgress(taskId: string, recipients: RecipientProgress[]): Promise<void>;
