...
import { ConversationSyncState, ChatMessage } from '@nx-platform-application/messenger-types';
/**
...
export declare abstract class ConversationStorage {
    ...
    abstract getConversationIndex(urn: URN): Promise<ConversationSyncState | undefined>;
