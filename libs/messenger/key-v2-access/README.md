...
This library provides the `SecureKeyService`, a critical component for the "Poke-then-Pull" architecture. It is the *only* service in the Angular application responsible for communicating with the V2 `go-key-service` backend.
