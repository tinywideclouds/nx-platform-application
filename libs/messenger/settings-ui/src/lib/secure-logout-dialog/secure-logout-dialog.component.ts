  ...
  template: `
    <div class="p-6 max-w-md">
      ...
      <div class="space-y-3 text-gray-700">
        <p>
          You are about to perform a <strong class="text-gray-900">Secure Wipe</strong>.
        </p>
        ...
        <p class="text-sm bg-red-50 p-3 rounded border border-red-100 text-red-800">
          This action cannot be undone. You will need to re-verify your identity if you log in again.
        </p>
      </div>
