...
describe('MessengerDatabase', () => {
  ...
  it('should be on version 8', () => {
    // Version 8 includes the new Outbox table schema
  ...
  it('should have the "outbox" table', () => {
    expect(db.outbox).toBeTruthy();
    expect(db.outbox.name).toBe('outbox');
  });
});
