 ...
 */
export const MESSAGE_TYPE_TEXT = 'urn:sm:type:text';
export const MessageTypeText = URN.parse('urn:sm:type:text');
export const MESSAGE_TYPE_CONTACT_SHARE = 'urn:sm:type:contact-share';

/**
 * The JSON schema for the 'urn:sm:type:contact-share' payload.
 */
export interface ContactSharePayload {
  /** The URN of the identity being shared (e.g., urn:sm:user:bob-123) */
  urn: string;
