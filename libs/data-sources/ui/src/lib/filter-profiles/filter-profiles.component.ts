...
import { FilterProfileFormComponent } from '../filter-profile-form/filter-profile-form.component';
...
@Component({
  selector: 'data-sources-filter-profiles',
  standalone: true,
  imports: [
    CommonModule,
    MatButtonModule,
