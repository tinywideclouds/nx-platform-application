...
- **contacts$: Observable<Contact[]>**
  - A live stream of _all_ contacts, ordered alphabetically by their alias.
- **favorites$: Observable<Contact[]>**
  - A live stream of _only_ contacts where isFavorite is set to true.
...
| **findByEmail(email: string)**      | Finds a contact by _any_ email in their emailAddresses array.                            |
| **findByPhone(phone: string)**      | Finds a contact by _any_ phone number in their phoneNumbers array.                       |
