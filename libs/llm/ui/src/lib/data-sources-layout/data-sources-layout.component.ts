...
// FEATURE COMPONENTS
import { LlmDataSourcesSidebarComponent } from '../data-sources-sidebar/data-sources-sidebar.component';

@Component({
  selector: 'llm-data-sources-layout',
  standalone: true,
  imports: [
    CommonModule,
    RouterOutlet,
