...
const DEFAULT_JWT_PRIVATE_KEY = 'a-crypto-lib-private-key-from-public-private-pair'
...
if (process.env.NODE_ENV === 'production') {
    if (config.sessionSecret === DEFAULT_SESSION_SECRET) {
        ...
        console.error("Please generate a secure, random secret and set it in the .env file.\n");
        process.exit(1);
    }
