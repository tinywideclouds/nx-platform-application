...
// Import application-specific modules with relative paths
...
export async function startTestServer() {
    ...
    const container = new GenericContainer('gcr.io/google.com/cloudsdktool/cloud-sdk:emulators')
    ...
    process.env.FIRESTORE_EMULATOR_HOST = `${firestoreContainer.getHost()}:${firestoreContainer.getMappedPort(8080)}`;
